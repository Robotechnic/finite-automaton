...
```shell
usage: finite-automaton [OPTIONS...] [FILE]
```
...
The starting state is usualy the first line of the file (see [File structure](#3-file-structure)) and it define the first state of the automaton after the creation.
